    ...
    <nav className={styles.navbar} >
      <div
        ...
        <div className={styles.containerMenu}>
          ...
          <a className={styles.butons} href="../../../../archives/HvAlejandroGuerra.pdf" download='Hv Alejandro Guerra' target="_blank" style={{ fontSize: 20, textDecoration: 'none', color: '#E40C38', fontFamily: 'Montserrat' }}>
          Mi Hv
          </a>
